...
export default component$(() => {
  return (
    <section className="container mx-auto px-8 pt-24 lg:pt-32 mb-24">
      <Text tag="h1">Terms and Conditions</Text>
      ...
      <Text tag="h2">Table of contents</Text>
      <ol className="list-decimal mb-8">
        <li>
          <Text noMargin>AGREEMENT TO TERMS </Text>
        </li>
        <li>
          <Text noMargin>INTELLECTUAL PROPERTY RIGHTS </Text>
        </li>
        <li>
          <Text noMargin>USER REPRESENTATIONS </Text>
        </li>
        <li>
          <Text noMargin>PROHIBITED ACTIVITIES </Text>
        </li>
        <li>
          <Text noMargin>USER GENERATED CONTRIBUTIONS </Text>
        </li>
        <li>
          <Text noMargin>CONTRIBUTION LICENSE </Text>
        </li>
        <li>
          <Text noMargin>SUBMISSIONS </Text>
        </li>
        <li>
          <Text noMargin>THIRD-PARTY WEBSITE AND CONTENT </Text>
        </li>
        <li>
          <Text noMargin>SITE MANAGEMENT </Text>
        </li>
        <li>
          <Text noMargin>PRIVACY POLICY </Text>
        </li>
        <li>
          <Text noMargin>TERM AND TERMINATION </Text>
        </li>
        <li>
          <Text noMargin>MODIFICATIONS AND INTERRUPTIONS </Text>
        </li>
        <li>
          <Text noMargin>GOVERNING LAW </Text>
        </li>
        <li>
          <Text noMargin>DISPUTE RESOLUTION </Text>
        </li>
        <li>
          <Text noMargin>CORRECTIONS </Text>
        </li>
        <li>
          <Text noMargin>DISCLAIMER </Text>
        </li>
        <li>
          <Text noMargin>LIMITATIONS OF LIABILITY </Text>
        </li>
        <li>
          <Text noMargin>INDEMNIFICATION </Text>
        </li>
        <li>
          <Text noMargin>USER DATA WEBSITE AND CONTENT </Text>
        </li>
        <li>
          <Text noMargin>
        ...
        <li>
          <Text noMargin>MISCELLANEOUS </Text>
        </li>
        <li>
          <Text noMargin>CONTACT US </Text>
        </li>
      </ol>
      <Text tag="h3">1. AGREEMENT TO TERMS</Text>
      <Text>
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (“you”) and Untied
        World AB, doing business as Untied ("Untied," “we," “us," or “our”),
        concerning your access to and use of the{" "}
        <Link href={"/"}>https://untied.world</Link> website as well as any
        ...
        “Site”). We are registered in Sweden and have our registered office at
        Bråvallagatan 8, 113 36 Stockholm. You agree that by accessing the Site,
        ...
        and to the extent local laws are applicable. The Site is intended for
        users who are at least 13 years of age. All users who are minors in the
      ...
      <Text tag="h3">2. INTELLECTUAL PROPERTY RIGHTS</Text>
      <Text>
      ...
      <Text tag={"h3"}> 3. USER REPRESENTATIONS</Text>{" "}
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 4. PROHIBITED ACTIVITIES</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 5. USER GENERATED CONTRIBUTIONS</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 6. CONTRIBUTION LICENSE</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 7. SUBMISSIONS</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 8. THIRD-PARTY WEBSITE AND CONTENT</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 9. SITE MANAGEMENT</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 10. PRIVACY POLICY</Text>
      <Text>
        {" "}
        We care about data privacy and security. Please review our Privacy
        Policy: https://untied.world/privacypolicy. By using the Site, you agree
        to be bound by our Privacy Policy, which is incorporated into these
        Terms of Use. Please be advised the Site is hosted in Sweden. If you
        ...
        differ from applicable laws in Sweden, then through your continued use
        of the Site, you are transferring your data to Sweden, and you agree to
        have your data transferred to and processed in Sweden.
      </Text>
      <Text tag={"h3"}> 11. TERM AND TERMINATION</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 12. MODIFICATIONS AND INTERRUPTIONS</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 13. GOVERNING LAW</Text>
      <Text>
        {" "}
        These conditions are governed by and interpreted following the laws of
        Sweden, and the use of the United Nations Convention of Contracts for
        ...
        your country of residence. Untied World AB and yourself both agree to
        submit to the non-exclusive jurisdiction of the courts of Stockholm,
        which means that you may make a claim to defend your consumer protection
        rights in regards to these Terms of Use in Sweden, or in the EU country
        in which you reside.
      </Text>
      <Text tag={"h3"}> 14. DISPUTE RESOLUTION</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 15. CORRECTIONS</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 16. DISCLAIMER</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 17. LIMITATIONS OF LIABILITY</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 18. INDEMNIFICATION</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 21. MISCELLANEOUS</Text>
      <Text>
        {" "}
      ...
      <Text tag={"h3"}> 22. CONTACT US</Text>
      <Text>
      ...
      <ul>
        <li>
          {" "}
          <Text noMargin>Untied World AB</Text>
        </li>
        <li>
          {" "}
          <Text noMargin> Bråvallagatan 8, 113 36, Stockholm, Sweden</Text>
        </li>
        <li>
          {" "}
          <Text noMargin>Phone: +46 70 659 66 31</Text>
        </li>
        <li>
          {" "}
          <Text noMargin>daniel (at) untied (dot) world</Text>
        </li>
      </ul>
    </section>
  );
