  ...
  return (
    <section className="container mx-auto px-8 pt-24 lg:pt-32">
        ...
        <ul className="list-disc mb-8">
          ...
          <li>
            <Text noMargin>
              ...
              in this Agreement) refers to Untied World AB, Bråvallagatan 8, 113
              36 Stockholm, Sweden.
            </Text>
          </li>
          <li>
          ...
          <li>
            <Text noMargin>
              <strong>Website</strong> refers to Untied World, accessible from{" "}
              <Link
                href="https://untied.world"
      ...
      <Text>
        ...
        website and on our web analytics product too. The privacy of your data —
        and it is your data.
      </Text>
      ...
      <ul className="list-disc mb-8">
        ...
        <li>
          <Text noMargin>
            ...
            publicly made available outside the Service in perpetuity. If You
      ...
      <Text>
        he Company will also retain Usage Data for internal analysis purposes.
      ...
      <Text tag={"h3"}>Delete Your Personal Data</Text>
      <Text>
